...
<div className={`absolute -top-3 -left-3 text-[12px] sm:text-sm font-extrabold px-3 py-1 rounded-full shadow-md z-10 ${review.panelName === '신작' ? 'bg-blue-600 text-white border border-blue-500' : (review.isRecommend === 'both' ? 'bg-gray-900 text-yellow-400 border border-yellow-500' : (review.isRecommend ? 'bg-gray-900 text-green-400 border border-green-500' : 'bg-gray-900 text-red-400 border border-red-500'))}`}>             </div>
